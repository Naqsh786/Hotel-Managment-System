      ...
      <div className="homepage-main">
         ...
         <section style={{ background: '#19191a', padding: '60px 0' }}>
            <div className="container-sona">
               <div className="grid-4" style={{ textAlign: 'center', color: '#fff' }}>
                  <div><h2 className="serif" style={{ color: '#dfa974', fontSize: '3.2rem', marginBottom: '10px' }}>150+</h2><p style={{ opacity: 0.8, fontSize: '18px', fontWeight: '500' }}>Luxury Rooms</p></div>
                  <div><h2 className="serif" style={{ color: '#dfa974', fontSize: '3.2rem', marginBottom: '10px' }}>5</h2><p style={{ opacity: 0.8, fontSize: '18px', fontWeight: '500' }}>Restaurants</p></div>
                  <div><h2 className="serif" style={{ color: '#dfa974', fontSize: '3.2rem', marginBottom: '10px' }}>15</h2><p style={{ opacity: 0.8, fontSize: '18px', fontWeight: '500' }}>Event Halls</p></div>
                  <div><h2 className="serif" style={{ color: '#dfa974', fontSize: '3.2rem', marginBottom: '10px' }}>10k</h2><p style={{ opacity: 0.8, fontSize: '18px', fontWeight: '500' }}>Happy Guests</p></div>
               </div>
            </div>
         </section>
         ...
         <section className="section-padding" style={{ background: 'var(--sona-bg)' }}>
            <div className="container-sona">
               <div className="flex-col flex-center" style={{ marginBottom: '40px', textAlign: 'center' }}>
                  <span className="text-primary" style={{ letterSpacing: '3px', fontWeight: '700', fontSize: '16px' }}>OUR SERVICES</span>
         ...
         {categories.length > 0 && (
            <section className="section-padding" style={{ background: 'var(--sona-bg-alt)' }}>
               <div className="container-sona">
                  <div className="flex-col flex-center" style={{ marginBottom: '40px', textAlign: 'center' }}>
                     <span className="text-primary" style={{ letterSpacing: '3px', fontWeight: '700', fontSize: '16px' }}>EXPLORE</span>
                        ...
                        >
                           {cat.image && (
                              <img
                                 src={cat.image}
                                 alt={cat.title}
                                 onError={(e) => { e.target.onerror = null; e.target.src = "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&w=800&q=80" }}
         ...
         <section className="section-padding" style={{ background: 'var(--sona-bg)' }}>
            <div className="container-sona">
               <div className="flex-col flex-center" style={{ marginBottom: '50px', textAlign: 'center' }}>
                  <span className="text-primary" style={{ letterSpacing: '3px', fontWeight: '700', fontSize: '16px' }}>OUR PREMIUM OFFERINGS</span>
         ...
         <section className="section-padding" style={{ background: 'var(--sona-bg-alt)' }}>
            <div className="container-sona">
               <div className="flex-col flex-center" style={{ marginBottom: '50px', textAlign: 'center' }}>
                  <span className="text-primary" style={{ letterSpacing: '3px', fontWeight: '700', fontSize: '16px' }}>TESTIMONIALS</span>
               ...
               <div className="grid-3" style={{ gap: '30px' }}>
                  {[
                     ...
                     <div key={idx} className="hover-lift" style={{ padding: '30px', background: 'var(--sona-bg)', borderRadius: '20px', border: '1px solid var(--sona-border)', position: 'relative' }}>
                        ...
                        <div className="flex items-center" style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
         ...
         <section className="section-padding">
            <div className="container-sona">
               <div className="flex-col flex-center" style={{ marginBottom: '50px', textAlign: 'center' }}>
                  <span className="text-primary" style={{ letterSpacing: '3px', fontWeight: '700', fontSize: '16px' }}>OUR GALLERY</span>
               ...
               <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px' }}>
                  ...
                  <img src="https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?auto=format&fit=crop&w=800&q=80" alt="Elegant Lounges" style={{ width: '100%', height: '300px', objectFit: 'cover', borderRadius: '15px' }} className="hover-lift" />
               </div>
